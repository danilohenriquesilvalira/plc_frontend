...
const ContraPeso_Montante: React.FC<ContraPesoMontanteProps> = ({ 
  ...
  const [abertura, setAbertura] = useState(posicaoInicial);
  
  const handleAberturaChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setAbertura(Number(event.target.value));
  };
  
  // Valor para animar a posição vertical dos elementos
  const deslocamento = abertura * 1.5;
  
  // Inverter a linha se for do lado direito
  const scaleX = lado === 'direito' ? -1 : 1;
  
  return (
    <div className="flex items-center gap-4">
      <div className="relative" style={{ width: '150px', height: '400px' }}>
        {/* Container para o SVG */}
        <div style={{ 
          position: 'relative', 
          width: '100%', 
          height: '100%',
          transform: lado === 'direito' ? 'scaleX(-1)' : 'none'
        }}>
          {/* Linha curva do contrapeso - ajustada para mover-se com a abertura */}
          <svg
            width="113"
            height="322"
            viewBox="0 0 113 322"
          ...
          >
            <path
              d="M108 221V221C109.105 221 110 220.105 110 219V27C110 13.7452 99.2548 3 86 3H26.5C13.2452 3 2.5 13.7452 2.5 27V322"
              stroke="black"
              strokeWidth="5"
          ...
          <div
            style={{
              position: 'absolute',
              bottom: `${30 - deslocamento}px`, // Move para baixo conforme aumenta a abertura
              left: '20px',
          ...
          >
            ...
            >
              <path
                d="M13.4174 133.751C4.81565 132.319 -0.01051 130.376 1.93841e-05 128.35L90.7087 128.349C90.687 130.376 86.9834 132.311 78.3589 133.745C69.7343 135.178 58.0484 135.985 45.8703 135.986C33.6923 135.987 22.0191 135.183 13.4174 133.751Z"
                fill="url(#paint0_linear_1738_3277)"
              />
              <path
                d="M13.4174 132.74C4.81565 131.308 -0.01051 129.365 1.93841e-05 127.338L90.7087 127.338C90.687 129.364 86.9834 131.299 78.3589 132.733C69.7343 134.167 58.0484 134.973 45.8703 134.974C33.6923 134.975 22.0191 134.171 13.4174 132.74Z"
                fill="url(#paint1_linear_1738_3277)"
              />
              <path
                d="M90.7048 128.319H0L0.22191 12.6689H90.7048V128.319Z"
                fill="url(#paint2_linear_1738_3277)"
              />
              <path
                d="M90.625 14.0973C90.625 14.5889 90.3775 15.1115 89.8135 15.6625C89.249 16.2141 88.3962 16.7642 87.2641 17.2993C85.0019 18.3687 81.7045 19.3416 77.5998 20.1623C69.3967 21.8025 58.0475 22.8196 45.5 22.8196C32.9525 22.8196 21.6033 21.8025 13.4002 20.1623C9.29551 19.3416 5.99809 18.3687 3.73588 17.2993C2.60382 16.7642 1.75104 16.2141 1.18647 15.6625C0.622521 15.1115 0.375 14.5889 0.375 14.0973C0.375 13.6057 0.622521 13.0831 1.18647 12.5321C1.75104 11.9805 2.60382 11.4304 3.73588 10.8952C5.99809 9.82587 9.29551 8.85294 13.4002 8.03226C21.6033 6.39212 32.9525 5.375 45.5 5.375C58.0475 5.375 69.3967 6.39212 77.5998 8.03226C81.7045 8.85294 85.0019 9.82587 87.2641 10.8952C88.3962 11.4304 89.249 11.9805 89.8135 12.5321C90.3775 13.0831 90.625 13.6057 90.625 14.0973Z"
                fill="url(#paint3_linear_1738_3277)"
                stroke="#C0C0C0"
                strokeWidth="0.75"
              />
              <ellipse
            ...
            {/* Texto "25t" no contrapeso */}
            <div
              style={{
                position: 'absolute',
                top: '50%',
                left: '50%',
                transform: `translate(-50%, -50%) ${lado === 'direito' ? 'scaleX(-1)' : ''}`,
                color: 'black',
                fontWeight: 'bold',
                fontSize: '20px',
                zIndex: 10
      ...
      {/* Controle deslizante para ajustar a abertura */}
